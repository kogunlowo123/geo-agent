"""GEO Agent - Domain-Specific Connectors."""
...
class HubspotMarketingConnector:
    """Domain-specific connector for hubspot marketing integration with GEO Agent."""
...
class MarketoConnector:
    """Domain-specific connector for marketo integration with GEO Agent."""
...
class MailchimpConnector:
    """Domain-specific connector for mailchimp integration with GEO Agent."""
...
class GoogleAnalyticsConnector:
    """Domain-specific connector for google analytics integration with GEO Agent."""
...
class MetaAdsConnector:
    """Domain-specific connector for meta ads integration with GEO Agent."""
