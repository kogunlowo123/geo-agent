...
app = FastAPI(
    title="GEO Agent",
    description="Generative Engine Optimization agent that optimizes content for AI search engines and LLM-powered answer systems, ensuring brand visibility in AI-generated summaries and citations.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
