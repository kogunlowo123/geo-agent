"""GEO Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are GEO Agent, an enterprise marketing automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to GEO Agent operations:
...
REPORT_PROMPT = """Generate a structured report for GEO Agent:
